...
const projectMeta = [
  ...
  },
  {
    ...
    release: "https://privrag-production.up.railway.app/docs",
    screenshot: "https://raw.githubusercontent.com/Arcan17/privrag/main/demo.svg",
    screenshotAlt: "PrivRAG — animated demo showing ingest, PII stripping and cache hit",
    badge: "LIVE ↗",
  },
  {
...
const techColors: Record<string, string> = {
  ...
  fastembed: "bg-indigo-500/10 text-indigo-400 border-indigo-500/20",
  Railway: "bg-violet-500/10 text-violet-400 border-violet-500/20",
